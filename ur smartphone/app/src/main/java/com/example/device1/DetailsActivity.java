...
public class DetailsActivity extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView web = findViewById(R.id.textView20);
        ...
        ClickableSpan cs2 = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                gotoUrl(device.getDeviceYoutubeUrl());
            }
        ...
        //Device Web Link
        String webLink = "Device WebSite";
        SpannableString ss2 = new SpannableString(webLink);
        ClickableSpan cs3 = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                gotoUrl(device.getDeviceWebSiteUrl());
            }
        ...
        ss2.setSpan(cs3,0,14, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        web.setText(ss2);
